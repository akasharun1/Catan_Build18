...
void loop() {
    ...
    lc.setDigit(dsp, LEDSIZE - 1, woodCount, false);
    lc.setDigit(dsp, LEDSIZE - 2, sheepCount, false);
    lc.setDigit(dsp, LEDSIZE - 3, clayCount, false);
    lc.setDigit(dsp, LEDSIZE - 4, wheatCount, false);
    lc.setDigit(dsp, LEDSIZE - 4, ironCount, false);
